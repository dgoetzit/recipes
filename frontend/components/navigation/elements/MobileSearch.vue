            ...
            >
                ...
                <div class="fixed inset-0 z-10 overflow-y-auto">
                    <div class="flex min-h-full items-start justify-center text-center sm:items-center">
                        ...
                        >
                            <DialogPanel
                                class="relative h-full w-full transform overflow-hidden bg-white text-left shadow-xl transition-all sm:my-8 sm:h-auto sm:w-full sm:max-w-2xl sm:rounded-lg"
                            >
                                    ...
                                    <div class="mt-4">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    {{ searchQuery ? 'Search Results' : 'Recipes You Might Enjoy' }}
                                                </h4>
                                                <div
                                                ...
                                                <ul
                                                    ...
                                                    class="-mx-4 max-h-60 divide-y divide-gray-200 overflow-y-auto sm:mx-0"
                                                >
                                                    <RecipeSlimCard
